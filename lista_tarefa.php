...
$finalistas = $test->query("SELECT * FROM `tarefa` ORDER BY `tarefa`.`descricao_tarefa` ASC ");
	...
	<nav class="uk-navbar-container banner" uk-navbar>
		<div class="uk-navbar-left">
			...
			<ul class="uk-navbar-nav">
				<li class="uk-parent uk-active"><a href="<?php echo URL_ADMIN ?>" >Pagina Inicial</a></li>
			</ul>
		</div>
    ...
    for ($contador = 0; $contador < $tamanhoLivros; $contador ++) {
        ?>
								<tr>
                                    ...
                                    <td class="uk-table-link"><?php echo $finalistas[$contador]['nome_aluno'];?></td>
									<td class="uk-table-link"><?php echo $finalistas[$contador]['descricao_tarefa'];?></td>
                                    <td class="uk-table-link"><?php echo $finalistas[$contador]['data_entrega'];?></td>
