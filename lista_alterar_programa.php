	...
	<div class="uk-section " style="padding-bottom: 3px;">
		<div class="uk-container">
			...
			<?php $_SESSION['excluido'] = ""; } ?>
			    <h3 style="font-size: 2em;">Lista de Todos os Programas do Curso</h3>
    ...
    for ($contador = 0; $contador < $tamanhoLivros; $contador ++) {
        ?>
								<tr>
									...
									<th class="uk-table-shrink"></th>
									<td class="uk-table-link"><?php echo $finalistas[$contador]['tamanho'];?></td>
									<th class="uk-table-shrink"></th>
									<td class="uk-table-link"><?php echo $finalistas[$contador]['arquivo'];?></td>
									<th class="uk-table-shrink"></th>
									<td class="uk-table-link"><p class="uk-margin">
										<a class="uk-button uk-button-danger" href="alterar_programa.php?alterar=<?php echo $finalistas[$contador]['id_programa'];?>">Alterar</a>
										</p>
									</td>
								</tr>
								<?php
