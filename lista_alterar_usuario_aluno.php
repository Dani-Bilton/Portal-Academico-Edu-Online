...
<nav class="uk-navbar-container banner" uk-navbar>
	<div class="uk-navbar-left">
		<a href="<?php echo URL_ALUNO ?>" class="uk-navbar-item uk-logo"> <i class="gg-home-alt line-icon"></i></a>
	...
	<div class="uk-container">
	    <?php 
			...
			<?php $_SESSION['excluido'] = ""; } ?>
			    <h3 style="font-size: 2em;">Lista de Todos os Alunos</h3>
								...
								<tr>
                                    <td class="uk-table-link"><?php echo $contador + 1;?></td>
									    <td><img class="uk-preserve-width uk-border-circle"
										    ...
										    <p uk-margin>
											    <a class="uk-button uk-button-danger" href="alterar_usuario_aluno.php?alterar=<?php echo $finalistas[$contador]['id_usuario'];?>">Alterar</a>
										    </p>
									    </td>
								</tr>
								<?php
