...
$curso = $_SESSION['nor1'];
$finalistas = $test->query("SELECT * FROM `curso` WHERE id_curso = '$curso' ORDER BY `curso`.`descricao` ASC ");
...
<div 
	...
	<nav class="uk-navbar-container banner" uk-navbar>
		<div class="uk-navbar-left">
			...
			<ul class="uk-navbar-nav">
				<li class="uk-parent uk-active"><a href="<?php echo URL_PROFESSOR ?>" >Gestão Formador</a></li>
			</ul>
		</div>
	...
	<div class="uk-section " style="padding-bottom: 3px;">
		<div class="uk-container">
			...
			<h3 style="font-size: 2em;">Lista de Todos os Meus Cursos</h3>
						...
						<table
							...
							<thead>
								<tr>
            						...
            						<th class="uk-table-shrink"></th>
            						<th class="uk-table-shrink"></th>
									<th class="uk-table-shrink">Descrição</th><th class="uk-table-shrink"></th>
            						<th class="uk-table-shrink"></th>
            						<th class="uk-table-shrink"></th>
									<th class="uk-table-shrink">Carga Horaria</th>
									<th class="uk-table-shrink"></th>
            						<th class="uk-table-shrink"></th>
            						<th class="uk-table-shrink"></th>
                                    <th class="uk-table-shrink">Data de Inicio</th>
									<th class="uk-table-shrink"></th>
            						<th class="uk-table-shrink"></th>
            						<th class="uk-table-shrink"></th>
                                    <th class="uk-table-shrink">Data de Fim</th>
								</tr>
							</thead>
							<tbody>
							<?php
    for ($contador = 0; $contador < $tamanhoLivros; $contador ++) {
		...
		<tr>
            ...
            <th class="uk-table-shrink"></th>
            <th class="uk-table-shrink"></th>
            <td class="uk-table-link"><?php echo $finalistas[$contador]['carga'];?></td>
			<th class="uk-table-shrink"></th>
            <th class="uk-table-shrink"></th>
            <th class="uk-table-shrink"></th>
            <td class="uk-table-link"><?php echo $finalistas[$contador]['Inicio'];?></td>
			<th class="uk-table-shrink"></th>
            <th class="uk-table-shrink"></th>
            <th class="uk-table-shrink"></th>
            <td class="uk-table-link"><?php echo $finalistas[$contador]['Fim'];?></td>
			<td class="uk-table-link ">
					<p uk-margin>
						<a class="uk-button uk-button-danger" href="lista_programa_professor.php">Ver Programas</a>
					</p>
			</td>
			<td class="uk-table-link ">
				<p uk-margin>
					<a class="uk-button uk-button-danger" href="programa.php">Criar Programa</a>
				</p>
			</td>
		</tr>
	<?php
