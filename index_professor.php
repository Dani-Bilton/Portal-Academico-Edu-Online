...
<body>
	<div class="barrainformacao" style="background: linear-gradient(to right, #02aab0, #00cdac);">
	...
	<nav class="uk-navbar-container banner" uk-navbar>
		<div class="uk-navbar-left">
			...
			<ul class="uk-navbar-nav">
				<li class="uk-parent uk-active"><a href="">Portal do Professor</a></li>
			</ul>
		</div>
			...
			<div class="uk-child-width-1-3@s uk-grid-match" uk-grid>
				<div>
					<div class="uk-card uk-card-default uk-card-small uk-card-body"
						...
						<h3 class="uk-card-title" style="color: white">Minha Conta</h3>
				...
				<div>
					<div class="uk-card uk-card-secondary uk-card-small uk-card-body"
						...
						<h3 class="uk-card-title" style="color: white">Curso</h3>
						<h3 style="color: white"><?php echo ""  ?></h3>
					</div>
				</div>
				<div>
					<div class="uk-card uk-card-default uk-card-small uk-card-body"
						...
						<h3 class="uk-card-title" style="color: white">Programa</h3>
						<h3 style="color: white"><?php echo ""  ?></h3>
					</div>
				</div>
                <div>
					<div class="uk-card uk-card-default uk-card-small uk-card-body"
						style="background: linear-gradient(to right,#ADDFE8, #B095E0 );">
						<h3 class="uk-card-title" style="color: white">Bate-Papo</h3>
						<h3 style="color: white"><?php echo ""  ?></h3>
					</div>
				</div>
			</div>
