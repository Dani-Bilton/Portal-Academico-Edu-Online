...
$finalistas = $test->query("SELECT * FROM `usuario` ORDER BY `usuario`.`nome_completo` ASC ");
								...
								<tr>
                                    <td class="uk-table-link"><?php echo $contador + 1;?></td>
									    <td><img class="uk-preserve-width uk-border-circle"
										    ...
										    <p uk-margin>
											    <a class="uk-button uk-button-danger" href="alterar_usuario.php?alterar=<?php echo $finalistas[$contador]['id_usuario'];?>">Alterar</a>
										    </p>
									    </td>
								</tr>
								<?php
