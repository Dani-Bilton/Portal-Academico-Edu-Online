			...
			<div class="uk-child-width-1-1@s uk-grid-match" uk-grid>
				<div>
					<div class="uk-card uk-card-default uk-card-small uk-card-body"
						...
						<h3 class="uk-card-title" style="color: white">Formulario de Cadastro de Curso</h3>
				...
				<div>
						...
						<div class="uk-container">
							<div class="uk-grid-match uk-child-width-1-1@m" uk-grid>
								<div>
									<form action="validar_curso.php" method="post">
										<fieldset class="uk-fieldset" uk-grid>
											...
											<div class="uk-width-1-2">
												...
												<div class="uk-margin">
													<input class="uk-input" type="text" placeholder="Carga Horaria"
														name="carga" required="required">
												</div>
											</div>
											<div class="uk-width-1-2">
												<div class="uk-margin">
												...
												<div class="uk-margin">
													<input class="uk-input" type="date"
														placeholder="Data de Inicio" name="inicio" required="required">
												</div>
											</div>
											<div class="uk-width-1-2">
												<div class="uk-margin">
												...
												<div class="uk-margin">
													<input class="uk-input" type="date" placeholder="Fim do Curso" name="fim">
												</div>
											</div>
