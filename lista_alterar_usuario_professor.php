...
<nav class="uk-navbar-container banner" uk-navbar>
	<div class="uk-navbar-left">
		<a href="<?php echo URL_PROFESSOR ?>" class="uk-navbar-item uk-logo"> <i class="gg-home-alt line-icon"></i></a>
    ...
    <div class="uk-navbar-right">
	    <ul class="uk-navbar-nav">
		    <li class="uk-parent"><a href="config/auth_out.php" class="uk-icon-link" uk-icon="close"></a></li>
	    </ul>
    </div>
</nav>
<div class="uk-section " style="padding-bottom: 3px;">
	<div class="uk-container">
	    <?php 
            if(isset($_SESSION['excluido']) && $_SESSION['excluido']!= "" ){ ?>
			    <div class="uk-alert-danger" uk-alert>
				    <a class="uk-alert-close" uk-close></a>
				<p><?php echo $_SESSION['excluido']; ?></p>
			</div>
			<?php $_SESSION['excluido'] = ""; } ?>
			    <h3 style="font-size: 2em;">Lista de Todos os Professores</h3>
						    ...
						    <table class="uk-table uk-table-hover uk-table-middle uk-table-divider">
							    <thead>
								    <tr>
									    ...
									    <th class="uk-table-shrink">Bilhete do Professor</th>
                                        ...
                                        <th class="uk-table-shrink">Curso</th>
								    </tr>
							    </thead>
						    <tbody>
							    <?php
								...
								<tr>
                                    <td class="uk-table-link"><?php echo $contador + 1;?></td>
									    <td><img class="uk-preserve-width uk-border-circle"
                                            ...
                                            <td class="uk-table-link"><?php echo $finalistas[$contador]['adm'];?></td>
                                            ...
                                            <td class="uk-table-link"><?php echo $finalistas[$contador]['id_curso_usuario'];?></td>
									        <td class="uk-table-link ">
										    <p uk-margin>
											    <a class="uk-button uk-button-danger" href="alterar_usuario_professor.php?alterar=<?php echo $finalistas[$contador]['id_usuario'];?>">Alterar</a>
										    </p>
									    </td>
								</tr>
								<?php
