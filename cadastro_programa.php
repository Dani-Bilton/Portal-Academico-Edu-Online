<!DOCTYPE html>
<?php include("validar_programa.php"); ?>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
...
<nav class="navbar">
    ...
    <div class="box">
        <form method="POST" enctype = "multipart/form-data" name="upload" action="validar_programa.php">
            <fieldset>
                <legend><b>Cadastro de Programa</b></legend><br>
                <div class="inputbox">
                    <input type="text" name="descricao" id="descricao" class="inputUser" required>
                    <label for="descricao" class="labelinput">Descrição do Programa</label>
                 </div><br></br>
                <label for="publicacao"><b>Data de Pubicação</b></label>
                <input type="date" name="publicacao" id="publicacao"  required>
                <br></br>
                <label for="expiracao"><b>Data de Expiração</b></label>
