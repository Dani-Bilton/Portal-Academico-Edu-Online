	...
	<nav class="uk-navbar-container banner" uk-navbar>
		<div class="uk-navbar-left">
			...
			<ul class="uk-navbar-nav">
				<li class="uk-parent uk-active"><a href="<?php echo URL_ALUNO ?>" >Área do Formando</a></li>
			</ul>
		</div>
    ...
    for ($contador = 0; $contador < $tamanhoLivros; $contador ++) {
		...
		<tr>
            ...
            <td class="uk-table-link ">
					<p uk-margin>
						<a class="uk-button uk-button-danger" href="lista_programa_aluno.php">Ver Programas</a>
					</p>
				</td>
		</tr>
	<?php
