...
$finalistas = $test->query("SELECT * FROM `programa` ORDER BY `programa`.`descricao` ASC ");
	...
	<nav class="uk-navbar-container banner" uk-navbar>
		<div class="uk-navbar-left">
			...
			<ul class="uk-navbar-nav">
				<li class="uk-parent uk-active"><a href="<?php echo URL_ADMIN ?>" >Gestão Administrador</a></li>
			</ul>
		</div>
						...
						<table
							...
							<thead>
								<tr>
                                    ...
                                    <th class="uk-table-shrink">Downloads</th>
								</tr>
							</thead>
							<tbody>
							<?php
    for ($contador = 0; $contador < $tamanhoLivros; $contador ++) {
        ?>
								<tr>
                                    ...
                                    <td class="uk-table-link"><?php echo $finalistas[$contador]['total'];?></td>						
								</tr>
								<?php
    }
    ?>
