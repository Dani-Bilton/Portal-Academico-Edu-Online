...
$finalistas = $test->query("SELECT * FROM `atividade` WHERE `tipo_usuario`= '0' ORDER BY `atividade`.`data_login` ASC ");
...
<div 
	...
	<div class="uk-section " style="padding-bottom: 3px;">
		<div class="uk-container">
			...
			<h3 style="font-size: 2em;">Atividade de Todos os Usuarios</h3>
						...
						<table
							...
							<thead>
								<tr>
									...
									<th class="uk-table-shrink">Usuario</th>
									<th class="uk-table-shrink">Data de Login</th>
                                    <th class="uk-table-shrink">Hora de Login</th>
                                    <th class="uk-table-shrink">Hora Logout</th>
								</tr>
							</thead>
							<tbody>
							<?php
    ...
    for ($contador = 0; $contador < $tamanhoLivros; $contador ++) {
        ?>
								...
								<tr>
									...
									<td class="uk-table-link"><?php echo $finalistas[$contador]['Usuario'];?></td>
                                    <td class="uk-table-link"><?php echo $finalistas[$contador]['data_login'];?></td>
                                    <td class="uk-table-link"><?php echo $finalistas[$contador]['hora_login'];?></td>
                                    <td class="uk-table-link"><?php echo $finalistas[$contador]['hora_logout'];?></td>
								</tr>
								<?php
    }
    ?>
