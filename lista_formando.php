...
$curso = $_SESSION['nor1'];
$finalistas = $test->query("SELECT * FROM `usuario` WHERE `id_curso_usuario`= '$curso' And `adm`='2' ORDER BY `usuario`.`nome_completo` ASC ");
...
<div 
	...
	<div class="uk-section " style="padding-bottom: 3px;">
		<div class="uk-container">
			...
			<h3 style="font-size: 2em;">Formandos inscritos neste curso</h3>
